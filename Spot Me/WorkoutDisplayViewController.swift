...
class WorkoutDisplayViewController: UIViewController {
    ...
    let basketballCenter = ["legDay": ["Stretch", "Leg Press", "Squat", "Hang Clean", "Vertical Leaps", "Step-Ups", "Walking Lunges", "Calf Raises","Stationary Bike", "Full Court Lunges", "One Legged Squats", "Hamstring Curls", "2 Mile Run", "Deep Side Lunges"],"upper": ["Bench Press", "Overhead Press", "Dubmbell Press", "Tricep Extensions" ], "agility": ["5-10-5", "Make 10 Free Throws in a row", "Stagger Sprints"]]
    
    let basketballPG = ["legDay": [ "Leg Press", "Squat", "Hang Clean", "Deadlift", "Stagger Sprints", "Lunges", "Box Jumps"],"upper": ["Bench Press", "Overhead Press", "Dubmbell Press" ], "agility": ["5-10-5"]]
    
    let basketballSG = ["legDay": [ "Leg Press", "Squat", "Hang Clean", "Deadlift", "Hamstring Curls", "One Legged Squats", "Lunges", "Box Jumps"],"upper": ["Bench Press", "Overhead Press", "Dubmbell Press" ], "agility": ["5-10-5", "Spot Shooting Drill", "Stagger Sprints", "3-point Shooting Drill", "Weak-Handed layups"]]
    
    let basketballForward = ["legDay": [ "Leg Press", "Squat", "Hang Clean", "Deadlift", "Stagger Sprints", "Lunges", "Box Jumps"],"upper": ["Bench Press", "Overhead Press", "Dubmbell Press" ], "agility": ["5-10-5"]]
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "ToLiftDescription"{
           ...
           destinationVC.reps = reps
           destinationVC.sets = sets
